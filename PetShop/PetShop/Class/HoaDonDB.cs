...
namespace PetShop.Class
{
    class HoaDonDB
    {
        string strConnection = @"server=HIEUCAN\MINHHIEU;database=QLBH_ViTinhDB;uid=sa;pwd=123456";
        ...
        public string GetDataToComponent(string MaHoaDon, string sql)
        { // from tblHoaDon
            string result = string.Empty;
            cnn = new SqlConnection(strConnection);
            SqlCommand cmd = new SqlCommand(sql, cnn);
